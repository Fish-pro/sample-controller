...
import (
	...
	samplecontrollerv1alpha1 "github.com/Fish-pro/sample-controller/pkg/apis/samplecontroller/v1alpha1"
	versioned "github.com/Fish-pro/sample-controller/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/Fish-pro/sample-controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/Fish-pro/sample-controller/pkg/generated/listers/samplecontroller/v1alpha1"
...
func (f *atInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&samplecontrollerv1alpha1.At{}, f.defaultInformer)
}
